...
<template>
  <ContentWrap>
    <el-button @click="goBack" class="mb-10px">
      <Icon icon="ep:arrow-left" class="mr-5px" /> 返回行项目列表
    </el-button>
  </ContentWrap>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="上架数量" align="center" prop="quantity" min-width="100" />
...
const receiptId = Number(route.query.receiptId)
const lineId = Number(route.query.lineId)
